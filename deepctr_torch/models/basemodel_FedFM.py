...
class BaseModel(nn.Module):
    ...
    def fit(self, x=None,
        ...
        try:
            ...
            elif "mse" in self.metrics.keys() or "nmae" in self.metrics.keys() or "logloss" in self.metrics.keys():
                ...
                with tqdm(enumerate(train_loader), disable=verbose != 1) as t:
                    for index, (x_train, y_train) in t:
                        ...
                        if index % 50 == 0:
                            ...
                            eval_str += "_ test_nmae: {0: .4f}".format(test_result["nmae"])
    ...
    def evaluate(self, x, y, batch_size=256):
        ...
        eval_result["nmae"] = self.nmae(pred_ans, y)
        return eval_result
    ...
    def add_regularization_loss(self, weight_list, weight_decay, p=1):
    ...
    def compile(self, optimizer,
                ...
                metrics=None,
                lr=None,
                logger_file_path="logging/log.log"
                ):
        """
    ...
    def check_best_model(self, eval_results, min_error):
        ...
        elif self.best_performance_metric in ["logloss", "binary_crossentropy", "mse", "nmae"]:
            is_best = eval_results[self.best_performance_metric] < min_error
        else:
            raise NotImplementedError
        return is_best
